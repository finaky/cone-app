...
export const Companies = () => {
  return (
    <section className="mt-16 w-full relative overflow-hidden h-[300px]">
      <div className="absolute w-full lg:h-[100px] h-[72px] bg-(--primary) -rotate-3 mt-20 flex lg:gap-25 gap-5">
